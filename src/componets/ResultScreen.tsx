...
const getScoreRange = (score: number): string => {
  if (score >= 9 && score <= 10) return '9-10 puntos';
  if (score >= 7.5 && score < 9) return '7.5-8.5 puntos';
  if (score >= 6 && score < 7.5) return '6-7 puntos';
  if (score >= 4.5 && score < 6) return '4.5-5.5 puntos';
  if (score >= 3 && score < 4.5) return '3-4 puntos';
  return '2.5 puntos';
};

// Función para obtener el color de la puntuación
const getScoreColor = (score: number): string => {
  if (score >= 9 && score <= 10) return 'text-green-600';
...
const getEvaluationMessage = (score: number): string => {
  if (score >= 9 && score <= 10) return '¡Excelente nivel de organización fiscal!';
